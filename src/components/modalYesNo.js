  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="modal-main-content">{message}</div>

        <div className="button-group modal-controls">
          <button className="btn btn-action" onClick={onNoButtonClickedHandler}>
            {noButtonLabel}
          </button>
          <button className="btn btn-action btn-primary" onClick={onYesButtonClickHandler}>
            {yesButtonLabel}
          </button>
        </div>
      </ModalWindow>
