      ...
      <header className="width-wrapper header-container clearfix">
        <div className="header-content">
          <section className="control-buttons fleft header-actions sidebar-toggle" onClick={toggleSideBar}>
            <i className="phxico phx-bars" />
          </section>
          <section className="brand clearfix fleft">
            <div className="logo fleft push-right" src="https://placehold.it/60x60" onClick={this._goLobby} />
          </section>
          ...
          <section className="control-buttons fleft header-actions">{this.props.children}</section>
