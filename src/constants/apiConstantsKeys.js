const apiConstantsKeys = {
  ...
  'Event Creator': ['riskSports', 'countries', 'templates', 'tags', 'placeTerms', 'bookTypes'],
  'Results Verifier': ['riskSports'],
  'Instant Action': ['riskSports', 'allOrigins', 'channels', 'brands'],
  Utilities: ['riskSports'],
  'Operator Manager': ['accountStatuses', 'currencies', 'languages', 'origins', 'priceFormatsShort'],
  'Payment Handler': ['currencies', 'paymentStatus', 'paymentColumns', 'paymentRejectReasons'],
  'Combination Risk Manager': ['channels', 'riskSports'],
}
