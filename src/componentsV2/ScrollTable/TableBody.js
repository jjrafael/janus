      ...
      {data.length ? (
        data.map((d, index) => {
          ...
          return (
            <div
              key={index}
              className={`rt-tr-group ${selectRow ? 'selectable' : ''} ${selectRow && selectedRow.id === d.id
                ? 'active'
                : ''} `}
              onClick={
                selectRow
            ...
            >
              <div className={className}>
                {headers.map((header, i) => {
                  ...
                  return (
                    <div
                      className={`rt-td col-description ${header.hasOwnProperty('class') ? header.class : ''}`}
